...
export default function VerifyScreen() {
    ...
    const handleResendOTP = async () => {
        ...
        try {
            const response = await fetch("https://quicktalk-backend-m3aq.onrender.com/resend-otp", {
                method: "POST",
    ...
    const handleVerify = async () => {
        ...
        try {
            const response = await fetch("https://quicktalk-backend-m3aq.onrender.com/verify-otp", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
